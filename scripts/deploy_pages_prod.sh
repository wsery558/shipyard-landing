#!/usr/bin/env bash
# Shipyard Landing - Production Deployment Script
# Target: https://shipyard-landing.pages.dev/
# Verifies: git repo, build, section anchors, then deploys

set -euo pipefail

REPO="${HOME}/code/shipyard-landing"
PROJECT_NAME="shipyard-tsaielectro"
BASE_URL="https://shipyard.tsaielectro.com"
BRANCH="shipyard-tsaielectro"
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🚀 Shipyard Landing - PRODUCTION DEPLOYMENT"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
function run_post_deploy_smoke() {
  ...
  for str in "${required_strings[@]}"; do
    if ! printf "%s" "$asset_js" | rg -q "$str"; then
...
if ! run_post_deploy_smoke "$BASE_URL"; then
  ...
  echo "  可能是自訂網域綁到別的 environment/branch 或別的 Pages 專案"
  echo "  建議立刻用 wrangler 列出 deployments / 專案資訊做對照"
  exit 1
fi
